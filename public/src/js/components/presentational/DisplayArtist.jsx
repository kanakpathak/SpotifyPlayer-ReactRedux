...
const DisplayArtist = ({ searchArtistName, name, artist }) => {
  return (
    <div className="row">
      ...
      <div className="col-sm-3">
        ...
        {artist.map((item, index) => (
          <div key={index} className={divX}>
            <b>Artist: </b>
            {item["name"]} <br />
            <b>followers: </b>
            {item["followers"]["total"]} <br />
            ...
            {item["id"]}
            <br />
            {/* <a href="http://localhost:8080/api/getAuth" /> */}
            {/* <Link
              to={{
                pathname: `/album/${accessToken}/${item["id"]}`
              }}
              className={link}
            >
              BLOCK
